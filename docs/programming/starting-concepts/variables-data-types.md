...
student = True # student is boolean type
```
...
```python
# Arithmetic
result = 5 + 4  # Addition, result 9
result = 10 - 3 # Subtraction, result 7
result = 4 * 5  # Multiplication, result 20

# Comparison
result = 5 > 4  # Greater than, result True
result = 7 < 10 # Less than, result True
