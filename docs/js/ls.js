...
`;
  ...
  var params_default = { back_to_top, bigger_picture, blog, breadcrumb, color, css_bundle_name, debug, docs, featured_image, footer, full_width_types, header, heading_sign, js_bundle_name, logo, modules, pagination, progress_bar, sass_transpiler, scrollbar, search, styles, terms };
