...
`;
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/giscus@v0.1.0/assets/hb/modules/giscus/js/index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/header@v0.12.0/assets/hb/modules/header/js/index.ts
  (() => {
    document.addEventListener("DOMContentLoaded", () => {
