...
`;
  ...
  var params_default = { back_to_top, bigger_picture, blog, breadcrumb, css_bundle_name, debug, docs, featured_image, footer, header, heading_sign, js_bundle_name, logo, modules, pagination, progress_bar, scrollbar, search, styles, terms };
