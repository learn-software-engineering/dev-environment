...
`;
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/base@v0.4.6/assets/hb/modules/base/js/responsive-table.ts
  (() => {
    "use strict";
