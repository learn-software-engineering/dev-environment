(() => {
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/dropdown.ts
  (() => {
    const hide = (dropdown) => {
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/keyboard.ts
  var Keyboard = class {
    keys = {};
    events = [];
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/navigator.ts
  var Navigator = class {
    modal() {
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/i18n.ts
  var i18n = new Translator(params_default.i18n, params_default.defaultLang);
  var i18n_default = i18n;

  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/engine.ts
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/historiographer.ts
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/form.ts
  var Form = class {
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/spinner.ts
  var Spinner = class {
    constructor(ele) {
      this.ele = ele;
    }
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/renderer.ts
  var Renderer = class {
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/shortcuts.ts
  var Navigate = {
    kbds: ["\u2191", "\u2193"],
...
<span class="search-shortcut-action">${shortcut["action"]}</span>
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/modal.ts
  var searchShortcut = {
  ...
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/search.ts
  var Search = class {
    container;
    form;
    shortcuts;
