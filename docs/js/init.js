(() => {
  // ns-hugo:/tmp/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/header/modules/theme-toggle@v0.3.1/assets/hb/modules/header-theme-toggle/init/index.ts
  (() => {
    "use strict";
